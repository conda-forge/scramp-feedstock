...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/scramp-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7713&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/scramp-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `scramp` can be installed with:

```
conda install scramp
```

It is possible to list all of the versions of `scramp` available on your platform with:
